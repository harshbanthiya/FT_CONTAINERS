...
vector<_T, _Allocator>::vector(size_type n)
  ...
  ft::uninitialized_fill(this->__begin_, this->__begin_ + n, value_type(), allocator_type());
  this->__end_ += n;
}
...
vector<_T, _Allocator>::vector(size_type n, const value_type& val)
    : __vector_base<_T, _Allocator>(n, allocator_type()) {
  ft::uninitialized_fill(this->__begin_, this->__begin_ + n, val, allocator_type());
  this->__end_ += n;
}
...
vector<_T, _Allocator>::vector(
  ...
  this->__end_ = ft::uninitialized_copy(first, last, this->__begin_, allocator_type());
}
...
vector<_T, _Allocator>::vector(const vector<_T, _Allocator>& other)
  ...
  clear();
  this->__end_ =
      ft::uninitialized_copy(other.__begin_, other.__end_, this->__begin_, allocator_type());
}
...
void vector<_T, _Allocator>::__reallocate(size_type __n) {
  ...
  ft::uninitialized_copy(this->__begin_, this->__end_, tmp.__begin_, allocator_type());
...
void vector<_T, _Allocator>::insert(iterator position, size_type n,
  ...
  ft::uninitialized_fill(__p, __p + n, val, allocator_type());
  this->__end_ += n;
}
...
void vector<_T, _Allocator>::insert(
  ...
  ft::uninitialized_copy(first, last, __p, allocator_type());
...
typename vector<_T, _Allocator>::iterator vector<_T, _Allocator>::erase(
  ...
  this->__a_.destroy(ft::uninitialized_copy(__p + 1, this->__end_--, __p, allocator_type()));
  return (iterator(this->__begin_ + __diff));
}
