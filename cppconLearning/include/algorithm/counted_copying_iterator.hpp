...
/*
    STL containters have a method 'assign(size_t, const T&) and another assign (It, It) -- this works with input iterators 
    By creating an iterator that yields exactly n copies of a const T& we can make it easy to implement the former in terms of the 
    latter 
*/
